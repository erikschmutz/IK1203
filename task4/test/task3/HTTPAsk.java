        ...
        while ((line = in.readLine()) != null && (line.length() != 0)) {
          try {
            if (line.indexOf("GET") == 0) {
              String hostName = (HTTPAsk.GetKeyFromParams(line, "hostname"));
              String hostPort = (HTTPAsk.GetKeyFromParams(line, "port"));
              String toServer = (HTTPAsk.GetKeyFromParams(line, "string"));


              String response;

              if(hostName==null || hostPort==null||line.indexOf("/ask?")==-1 ){
                throw new Exception();
              }
